...
namespace CalculatorParser
{
    ...
    public class ValidityChecker
    {
        ...
        public bool ValidityCheck(List<Token> token)
        {
            // 括弧の数が合っているか
        ...
        public bool ParamCheck(List<Token> token)
        {
        ...
        public bool OperatorCheck(List<Token> token)
        {
        ...
        public bool DotCheck(List<Token> token)
        {
